...
class Operation:
    ...
    **Why Static Methods?**
    ...
    def modulo(a: float, b: float) -> float:
        """
        Calculates the modulo (remainder) of two floating-point numbers and returns the result.
        ...
        **Advantages of Static Methods in Utility Classes:**
        ...
        """
        if b == 0:
            raise ValueError("Cannot perform modulo operation with divisor of zero")
        return a % b  # Calculates the remainder of a divided by b and returns the result.
    
    @staticmethod
    def square_root(a: float) -> float:
        """
        Calculates the square root of a floating-point number and returns the result.
        ...
        **Advantages of Static Methods in Utility Classes:**
        ...
        return math.sqrt(a)  # Calculates the square root of a and returns the result.
